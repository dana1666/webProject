...
else if(isset($_SESSION['babysitterEmail']))
{
                     ...
                     <div id="errorMessage"> 
                        ...
                        ?>
                              ...
                              <div class="form-outline">
                                ...
                                <input type="text" id="First_Name" class="form-control" name = "fnameB" value="<?php echo $Fname; ?>">
                              </div>
                              <br>
                              <div class="form-outline">
                                <label class="form-label" for="Last_Name"><strong>Last Name</strong></label>
                                <input type="text" id="Last_Name" class="form-control" name = "lnameB" value="<?php echo $Lname; ?>">
                              </div>
                              <br>
                            <div class="form-outline">
                              <label class="form-label" for="Email"><strong>Email</strong></label>
                              <input type="email" id="Email" class="form-control" name ="emailB" value="<?php echo $Email; ?>">
                            </div>
                            <br>
                            <div class="form-outline">
                              <label class="form-label" for="Password"><strong>Password</strong></label>
                              <input type="password" id="Password" class="form-control"  name = "passB" value="<?php echo $password; ?>">
                            </div>
                            <br>
                            <div class="form-outline">
                              <label class="form-label" for="userID"><strong>User ID</strong></label>
                              <input type="text" id="userID" class="form-control" name ="userID" value="<?php echo $userID; ?>" >
                            </div>
                            <br>
                            <div class="form-outline">
                            ...
                            <br>
                              ...
                              <div class="form-outline">
                                ...
                                <input type="tel" id="phone" class="form-control"  name = "phone" value="<?php echo $PhoneNo; ?>">
                              </div>
                            ...
                            <br>
                              ...
                              <div class="form-outline">
                                ...
                                <textarea class="form-control" id="bio" rows="4" placeholder="Share a little information about yourself" name="bio" value="<?php echo $bio; ?>"></textarea>
                              </div>
                              <br>
