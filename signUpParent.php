                    ...
                    <br>
                      ...
                      <div class="d-flex justify-content-center" >
                        ...
                        <div class="form-outline" >
                          ...
                          <input type="text" id="FirstName" class="form-control" name= "fnameP" value="<?php echo $Fname; ?>" >
                        </div>
                        <br>
                        <div class="form-outline">
                          <label class="form-label" for="LastName"><strong>Last Name</strong></label>
                          <input type="text" id="LastName" class="form-control" name= "lnameP" value="<?php echo $Lname; ?>"> 
                        </div>
                        <br>

                      <div class="form-outline">
                        <label class="form-label" for="typeEmail"><strong>Email</strong></label>
                        <input type="text" id="typeEmail" class="form-control"  name= "emailP" value="<?php echo $Email; ?>" >
                      </div>

                      <br>
                      <div class="form-outline">
                        <label class="form-label" for="typePassword"><strong>Password</strong></label>
                        <input type="password" id="typePassword" class="form-control"  name="passP" value="<?php echo $password; ?>">
                      </div>
