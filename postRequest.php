...
<body>
      ...
      <div class="navbar navbar-expand-lg navbar-light text-light " style="background-color: rgb(227, 217, 175);">
          ...
          <div class="container h-100">
                ...
                <div class="card text-black">
                  <div class="card-body p-md-5">
                        ...
                        <form class="mx-1 mx-md-4" action= "PHP/requestInsert.php" method = "post" id="postRequestForm">
                        ...
                        <div class="row align-items-start">
                          ...
                          <div class="d-flex  align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                              ...
                              <input type="text" name="names" class="form-control" id="names" minlength="2" required>
                          ...
                          <div class="d-flex  align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                              ...
                              <input type="text" name="ages" id="ages" class="form-control" id="2" min="0" max="17" required>
                       ...
                       <!-- the end of the 1st row -->
                        ...
                        <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                            ...
                            <label class="form-label" for = "service" ><strong>Type of service*</strong></label>
                              <select class="form-select" id = "service" name="type" required>
                      ...
                      <div class="row align-items-start">
                        ...
                        <label class="form-label" for="flatpickr"> <strong>Start Day*</strong></label><br>
                          <input id="datepickr" type="date"  class="form-control" name="startDay" min="<?php echo date('Y-m-d', strtotime('+1 days')); ?>" required><br>
                        </div>
                        <div class="col">
                        <label class="form-label" for="flatpickr1"> <strong>End Day*</strong></label><br>
                        <input id="datepickr1" type="date" class="form-control" name="endDay" min="<?php echo date('Y-m-d', strtotime('+1 days')); ?>" required><br>
                      ...
                      <div class="row align-items-start">
                        <div class="col">
                           ...
                           <input type="time" id="appt" name="startTime" class="form-control" required><br>
                        </div>
                        <div class="col">
                        <label for="appt1"> <strong> End time*</strong></label><br>
                           <input type="time" id="appt1" name="endTime" class="form-control" required>
                        </div>
                      </div>
    
                 
                          <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                            <button class="btn btn-outline-secondary btn-lg" name="postRequest" type="submit"  id="show" >Post Request</button>
        ...
        $('#postRequestForm').submit(function(e){
              $('#errorMessage').html("");
              $('#errorMessage').css('display', 'none');
              $('#success_alert').html("");
              $('#success_alert').css('display', 'none');
              $('#postRequestForm').removeAttr('target')
              
            
              var thereIsError = false;
              if(!commaSeparatedName($('#names').val())){
                document.getElementById('errorMessage').innerHTML += '&#9679; kid name should be at least 2 letters, and should not contain special characters or digits <br> except for a comma when you need to seperate multiple names.<br>'; 
                thereIsError = true;
              }
              ...
              if((thereIsError === true)){
                e.preventDefault();
                $('#postRequestForm').attr('target','my_iframe');
